...
const cliente_strategy_1 = require("./strategies/cliente.strategy");
class App extends (0, boot_1.BootMixin)((0, service_proxy_1.ServiceMixin)((0, repository_1.RepositoryMixin)(rest_1.RestApplication))) {
    constructor(options = {}) {
        ...
        (0, authentication_1.registerAuthenticationStrategy)(this, cliente_strategy_1.EstrategiaCliente);
        this.component(authentication_1.AuthenticationComponent);
        (0, authentication_1.registerAuthenticationStrategy)(this, asesor_strategy_1.EstrategiaAsesor);
        this.component(authentication_1.AuthenticationComponent);
    }
}
exports.App = App;
