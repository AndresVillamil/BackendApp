...
let RolesRepository = class RolesRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource, permisosRepositoryGetter) {
        super(models_1.Roles, dataSource);
        this.permisosRepositoryGetter = permisosRepositoryGetter;
...
RolesRepository = (0, tslib_1.__decorate)([
    (0, tslib_1.__param)(0, (0, core_1.inject)('datasources.mongobd')),
    (0, tslib_1.__param)(1, repository_1.repository.getter('PermisosRepository')),
